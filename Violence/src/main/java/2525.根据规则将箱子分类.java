...
class Solution {
    public String categorizeBox(int length, int width, int height, int mass) {
        ...
        String flag1 = "";
        String flag2 = "";
        if ((length >= 10000 || width >= 10000 || height >= 10000) || (long) length * width * height >= bulk) {
            flag1 = "Bulky";
        }
        if (mass >= 100) {
            flag2 = "Heavy";
        ...
        if (flag1.equals("Bulky") && flag2.equals("Heavy")) {
            return "Both";
        } else if (flag1.equals("") && flag2.equals("")) {
            return "Neither";
        } else if (flag1.equals("Bulky") && flag2.equals("")) {
            return "Bulky";
        } else {
            return "Heavy";
        }
